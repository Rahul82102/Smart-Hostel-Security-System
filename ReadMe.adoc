...
```
=== thingProperties.h (Auto-generated by IoT Cloud)
The code for the thingProperties.h would look similar as below, depending on the name of the defined cloud variable of the named components below:

- CloudSwitch controlState;
- int usonic; // Ultrasonic Cloud Variable Name
- bool gLED; // Green LED Cloud Variable Name
- bool rLED; // Red LED Cloud Variable Name
- bool yLED; // Yellow LED Cloud Variable Name
